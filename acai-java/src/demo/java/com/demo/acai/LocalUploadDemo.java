...
public class LocalUploadDemo {
  ...
  public static void main(String[] args) throws InterruptedException {
    // Create and initialize Acai client
    ...
    client.setLogMode(AcaiLog.LogMode.DEBUG);
    ...
    // https://developers.acai-server.com/docs/batch-event-upload-api#feature-comparison-between-httpapi-2httpapi--batch
