...
public class HttpTransportTest {
  ...
  @BeforeEach
  public void setUp() {
    httpTransport = new HttpTransport(null, null, new AcaiLog(), 0);
  }
  ...
  @Test
  public void testRetryEvents() throws AcaiInvalidAPIKeyException, InterruptedException {
  ...
  public void testRetryEventsWithInvalidEvents()
      throws AcaiInvalidAPIKeyException, InterruptedException {
  ...
  @Test
  public void testFailedResponse() throws AcaiInvalidAPIKeyException, InterruptedException {
    Response failedResponse = ResponseUtil.getFailedResponse();
    Response successResponse = ResponseUtil.getSuccessResponse();
    HttpCall httpCall = mock(HttpCall.class);
    CountDownLatch latch = new CountDownLatch(2);
  ...
  @Test
  public void testUnknownResponse() throws AcaiInvalidAPIKeyException, InterruptedException {
  ...
  @Test
  public void testShutdownCallback() throws AcaiInvalidAPIKeyException, InterruptedException {
    Response successResponse = ResponseUtil.getSuccessResponse();
    HttpCall httpCall = mock(HttpCall.class);
