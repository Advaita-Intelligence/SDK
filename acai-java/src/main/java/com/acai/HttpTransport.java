...
class HttpTransport {
  ...
  private AcaiCallbacks callbacks;
  ...
  HttpTransport(
      HttpCall httpCall, AcaiCallbacks callbacks, AcaiLog logger, long flushTimeout) {
  ...
  public void setLogger(AcaiLog logger) {
    this.logger = logger;
  }
  ...
  private CompletableFuture<Response> sendEvents(List<Event> events) {
    return CompletableFuture.supplyAsync(
        () -> {
          ...
          } catch (AcaiInvalidAPIKeyException e) {
  ...
  private EventsRetryResult retryEventsOnce(String userId, String deviceId, List<Event> events)
      throws AcaiInvalidAPIKeyException {
