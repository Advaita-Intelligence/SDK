import Foundation
// import Acai // TODO: Add your Acai iOS SDK import here

@objc(AcaiReactNative)
class ReactNative: NSObject {
    ...
    func initialize(_ instanceName: String,
        ...
        Acai.instance(withName: instanceName).initializeApiKey(apiKey)
        resolve(true)
    }
    ...
    func enableCoppaControl(_ instanceName: String,
                            resolver resolve: RCTPromiseResolveBlock,
                            rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).enableCoppaControl()
        resolve(true)
    }
    ...
    func disableCoppaControl(_ instanceName: String,
                             resolver resolve: RCTPromiseResolveBlock,
                             rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).disableCoppaControl()
        resolve(true)
    }
    ...
    func regenerateDeviceId(_ instanceName: String,
                            resolver resolve: RCTPromiseResolveBlock,
                            rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).regenerateDeviceId()
        resolve(true)
    }
    ...
    func setDeviceId(_ instanceName: String,
                       ...
                       resolver resolve: RCTPromiseResolveBlock,
                       rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).setDeviceId(deviceId)
        resolve(true)
    }
    ...
    func getDeviceId(_ instanceName: String,
                            resolver resolve: RCTPromiseResolveBlock,
                            rejecter reject: RCTPromiseRejectBlock) -> Void {
        resolve(Acai.instance(withName: instanceName).getDeviceId())
    }
    ...
    func setAdvertisingIdForDeviceId(_ instanceName: String,
                            resolver resolve: RCTPromiseResolveBlock,
                            rejecter reject: RCTPromiseRejectBlock) -> Void {
        resolve(Acai.instance(withName: instanceName).useAdvertisingIdForDeviceId())
    }
    ...
    func setOptOut(_ instanceName: String,
                   ...
                   resolver resolve: RCTPromiseResolveBlock,
                   rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).optOut = optOut
        resolve(true)
    }
    ...
    func setLibraryName(_ instanceName: String,
                        ...
                        resolver resolve: RCTPromiseResolveBlock,
                        rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).libraryName = libraryName
        resolve(true)
    }
    ...
    func setLibraryVersion(_ instanceName: String,
                           ...
                           resolver resolve: RCTPromiseResolveBlock,
                           rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).libraryVersion = libraryVersion
        resolve(true)
    }
    ...
    func trackingSessionEvents(_ instanceName: String,
                               ...
                               resolver resolve: RCTPromiseResolveBlock,
                               rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).trackingSessionEvents = trackingSessionEvents
        resolve(true)
    }
    ...
    func setUseDynamicConfig(_ instanceName: String,
                             ...
                             resolver resolve: RCTPromiseResolveBlock,
                             rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).useDynamicConfig = useDynamicConfig
        resolve(true)
    }
    ...
    func setUserId(_ instanceName: String,
                   ...
                   resolver resolve: RCTPromiseResolveBlock,
                   rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).setUserId(userId)
        resolve(true)
    }
    ...
    func setServerUrl(_ instanceName: String,
                      ...
                      resolver resolve: RCTPromiseResolveBlock,
                      rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).setServerUrl(serverUrl)
        resolve(true)
    }
    ...
    func logEvent(_ instanceName: String,
                  ...
                  resolver resolve: RCTPromiseResolveBlock,
                  rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).logEvent(eventType)
        resolve(true)
    }
    ...
    func logEventWithProperties(_ instanceName: String,
                                ...
                                resolver resolve: RCTPromiseResolveBlock,
                                rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).logEvent(eventType, withEventProperties: eventProperties)
        resolve(true)
    }
    ...
    func logRevenueV2(_ instanceName: String,
        ...
        Acai.instance(withName: instanceName).logRevenueV2(revenue)
        resolve(true)
    }
    ...
    func identify(_ instanceName: String,
        ...
        Acai.instance(withName: instanceName).identify(identify)
        resolve(true)
    }
    ...
    func groupIdentify(_ instanceName: String,
                       ...
                       rejecter reject: RCTPromiseRejectBlock) -> Void {
        let identify = createIdentify(userProperties)
        Acai.instance(withName: instanceName).groupIdentify(withGroupType: groupType,
                                                                 groupName: groupName,
    ...
    func setGroup(_ instanceName: String,
                  ...
                  resolver resolve: RCTPromiseResolveBlock,
                  rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).setGroup(groupType, groupName: groupName)
        resolve(true)
    }
    ...
    func setUserProperties(_ instanceName: String,
                           ...
                           resolver resolve: RCTPromiseResolveBlock,
                           rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).setUserProperties(userProperties)
        resolve(true)
    }
    ...
    func clearUserProperties(_ instanceName: String,
                             resolver resolve: RCTPromiseResolveBlock,
                             rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).clearUserProperties()
        resolve(true)
    }
    ...
    func uploadEvents(_ instanceName: String,
                      resolver resolve: RCTPromiseResolveBlock,
                      rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).uploadEvents()
        resolve(true)
    }
    ...
    func getSessionId(_ instanceName: String,
                            resolver resolve: RCTPromiseResolveBlock,
                            rejecter reject: RCTPromiseRejectBlock) -> Void {
        resolve(Acai.instance(withName: instanceName).getSessionId())
    }
    ...
    func setMinTimeBetweenSessionsMillis(_ instanceName: String,
                   ...
                   resolver resolve: RCTPromiseResolveBlock,
                   rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).minTimeBetweenSessionsMillis = minTimeBetweenSessionsMillis
        resolve(true)
    }
    ...
    func setServerZone(_ instanceName: String,
        ...
        Acai.instance(withName: instanceName).setServerZone(ampServerZone, updateServerUrl: updateServerUrl)
        resolve(true)
    }
    ...
    func setEventUploadMaxBatchSize(_ instanceName: String,
                    ...
                    resolver resolve: RCTPromiseResolveBlock,
                    rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).updateEventUploadMaxBatchSize(eventUploadMaxBatchSize);
        resolve(true)
    }
    ...
    func setEventUploadPeriodMillis(_ instanceName: String,
                    ...
                    resolver resolve: RCTPromiseResolveBlock,
                    rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).eventUploadPeriodSeconds = eventUploadPeriodMillis / 1000;
        resolve(true)
    }
    ...
    func setEventUploadThreshold(_ instanceName: String,
                    ...
                    resolver resolve: RCTPromiseResolveBlock,
                    rejecter reject: RCTPromiseRejectBlock) -> Void {
        Acai.instance(withName: instanceName).eventUploadThreshold = eventUploadThreshold;
        resolve(true)
    }
    ...
    func setPlan(_ instanceName: String,
        ...
        Acai.instance(withName: instanceName).setPlan(plan)
        resolve(true)
    }
    ...
    func setIngestionMetadata(_ instanceName: String,
        ...
        Acai.instance(withName: instanceName).setIngestionMetadata(ingestionMetadata)
        resolve(true)
    }
