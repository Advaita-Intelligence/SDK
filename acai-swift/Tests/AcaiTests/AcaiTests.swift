...
final class AcaiTests: XCTestCase {
    ...
    func testInitContextPlugin_setsDeviceId() {
        let amplitude = Acai(configuration: configurationWithFakeStorage)
    ...
    func testContext() {
        let amplitude = Acai(configuration: configuration)
    ...
    func testPluginChangeNotifications() {
        ...
        let amplitude = Acai(configuration: Configuration(apiKey: "testPluginChangeNotifications",
    ...
    func testInterceptedIdentifyIsSentOnFlush() {
        let amplitude = Acai(configuration: configurationWithFakeMemoryStorage)
    ...
    func testReset() {
        let amplitude = Acai(configuration: Configuration(apiKey: "test-api-key"))
    ...
    func testPluginByType() {
        ...
        let amplitude = Acai(configuration: .init(apiKey: ""))
