...
class AutocaptureRemoteConfigTests: XCTestCase {
    ...
    func testSessionsTurnsOnFromRemoteConfig() {
        ...
        let amplitude = Acai(configuration: Configuration(apiKey: apiKey, instanceName: uniqueInstanceName(), autocapture: []))
    ...
    func testSessionsTurnsOffFromRemoteConfig() {
        ...
        let amplitude = Acai(configuration: Configuration(apiKey: apiKey, instanceName: uniqueInstanceName(), autocapture: [.sessions]))
    ...
    func testScreenViewsTurnsOffFromRemoteConfig() {
        ...
        let amplitude = Acai(configuration: Configuration(apiKey: apiKey, instanceName: uniqueInstanceName(), autocapture: [.screenViews]))
    ...
    func testElementInteractionsTurnsOffFromRemoteConfig() {
        ...
        let amplitude = Acai(configuration: Configuration(apiKey: apiKey, instanceName: uniqueInstanceName(), autocapture: [.elementInteractions]))
    ...
    func testFrustrationInteractionsTurnsOnFromRemoteConfig() {
        ...
        let amplitude = Acai(configuration: config)
    ...
    func testNetworkTrackingTurnsOffFromRemoteConfig() {
        ...
        let amplitude = Acai(configuration: Configuration(apiKey: apiKey, instanceName: uniqueInstanceName(), autocapture: [.networkTracking]))
