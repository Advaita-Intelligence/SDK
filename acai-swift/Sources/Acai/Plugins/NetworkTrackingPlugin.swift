...
class NetworkTrackingPlugin: UtilityPlugin, NetworkTaskListener {
    ...
    let networkTrackingQueue = DispatchQueue(label: "com.acai.analytics.networkTracking", attributes: .concurrent)
    ...
    override func setup(amplitude: Acai) {
