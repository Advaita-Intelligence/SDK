...
public class Acai {
    ...
    weak var interfaceSignalProvider: InterfaceSignalProvider? {
        didSet {
#if (os(iOS) || os(tvOS) || os(visionOS) || targetEnvironment(macCatalyst)) && !ACAI_DISABLE_UIKIT
    ...
    let trackingQueue = DispatchQueue(label: "com.acai.analytics")
    ...
    public init(
        ...
        _ = add(plugin: AcaiDestinationPlugin())
    ...
    @discardableResult
    public func track(event: BaseEvent, options: EventOptions? = nil, callback: EventCallback? = nil) -> Acai {
        if options != nil {
    ...
    @discardableResult
    public func track(eventType: String, eventProperties: [String: Any]? = nil, options: EventOptions? = nil) -> Acai {
    ...
    public func logEvent(event: BaseEvent) -> Acai {
        return track(event: event)
    }

    @discardableResult
    public func identify(userProperties: [String: Any]?, options: EventOptions? = nil) -> Acai {
        return identify(identify: convertPropertiesToIdentify(userProperties: userProperties), options: options)
    }

    @discardableResult
    public func identify(identify: Identify, options: EventOptions? = nil) -> Acai {
    ...
    @discardableResult
    public func revenue(event: RevenueEvent) -> Acai {
        process(event: event)
        return self
    }
    ...
    @discardableResult
    public func remove(plugin: UniversalPlugin) -> Acai {
    ...
    @discardableResult
    public func setUserId(userId: String?) -> Acai {
        identity.userId = userId
        return self
    }

    @discardableResult
    public func setDeviceId(deviceId: String?) -> Acai {
        identity.deviceId = deviceId
        return self
    }
    ...
    @discardableResult
    public func setSessionId(timestamp: Int64) -> Acai {
    ...
    @discardableResult
    public func setSessionId(date: Date) -> Acai {
...
extension Acai: AnalyticsClient {
