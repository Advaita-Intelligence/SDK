...
from acai import Config, EventPlugin, PluginType, BaseEvent
from acai.timeline import Timeline
from acai.plugin import AcaiDestinationPlugin


class AcaiTimelineTestCase(unittest.TestCase):
    ...
    def test_timeline_add_remove_plugins_with_types_success(self):
        ...
        destination = AcaiDestinationPlugin()
