...
from acai import Acai, Config, BaseEvent, Identify, EventOptions, IdentifyEvent, GroupIdentifyEvent, \
    RevenueEvent, Revenue, EventPlugin, DestinationPlugin, PluginType
from acai.http_client import HttpClient, Response, HttpStatus


class AcaiClientTestCase(unittest.TestCase):

    def setUp(self) -> None:
        self.client = Acai(api_key="test api key",
    ...
    def test_amplitude_client_init_multiple_instance(self):
        ...
        client1 = Acai(api_key="test api key 1")
        client2 = Acai(api_key="test api key 2")
    ...
    def test_amplitude_add_remove_plugins_success(self):
        timeline = self.client._Acai__timeline
