...
SERVER_URL = {
    EU_ZONE: {
        BATCH: "https://api.eu.acai.io/batch",
        HTTP_V2: "https://api.eu.acai.io/2/httpapi"
    },
    DEFAULT_ZONE: {
        BATCH: "https://api.acai.io/batch",
        HTTP_V2: "https://api.acai.io/2/httpapi"
    }
}
LOGGER_NAME = "acai"
