"""A very simple example of using Acai Python SDK to track  events"""

from acai import Acai, BaseEvent, Identify, EventOptions, Revenue
...
# Initialize a Acai client instance
amp_client = Acai(api_key="YOUR API KEY")
