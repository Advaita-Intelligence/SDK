...
/// Refer to [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#autocapture) for more details.
///
/// Example usage:
///
///```dart
...
class AutocaptureOptions extends Autocapture {
  /// Web specific
  ///
  /// Configures marketing attribution tracking using `AttributionOptions`. See [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#track-marketing-attribution)
  ...
  /// See https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#track-sessions
  final bool sessions;

  /// Web specific
  ///
  /// Configuration for autocapturing page view events using `PageViewsOptions`. See [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#track-page-views)
