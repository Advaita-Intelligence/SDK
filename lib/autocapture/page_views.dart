...
/// Refer to [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#track-page-views) for more details.
///
/// Example usage:
///
///```dart
...
class PageViewsOptions extends PageViews {
  ...
  ///   For example, navigating from `https://acai.io/#company` to `https://acai.io/#blog`.
  ///
  ...
  /// See [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#track-page-views)
  ...
  ///
  /// See [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#autocapture) for more information.
