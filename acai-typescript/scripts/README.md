...
This directory contains utility scripts for the Acai TypeScript monorepo.
...
**Replacements:**
- For `@acai/analytics-types` and `@acai/analytics-client-common`: Use `@acai/analytics-core`
- For `@acai/analytics-remote-config`: Use the new remote config client in `@acai/analytics-core`
