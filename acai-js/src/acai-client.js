...
import { AcaiServerZone, getEventLogApi } from './server-zone';
...
/**
 * AcaiClient SDK API - instance constructor.
 * The Amplitude class handles creation of client instances, all you need to do is call amplitude.getInstance()
 * @constructor AcaiClient
 * @public
 * @example var amplitudeClient = new AcaiClient();
 */
var AcaiClient = function AcaiClient(instanceName) {
  if (!isBrowserEnv() && !utils.isWebWorkerEnvironment()) {
    utils.log.warn(
      'acai-js will not work in a non-browser environment. If you are planning to add Amplitude to a node environment, please use @amplitude/node',
    );
  }
...
AcaiClient.prototype.Identify = Identify;
AcaiClient.prototype.Revenue = Revenue;
 ...
 */
AcaiClient.prototype.init = function init(apiKey, opt_userId, opt_config, opt_callback) {
...
AcaiClient.prototype._runNewSessionStartCallbacks = function () {
  for (let i = 0; i < this._onNewSessionStartCallbacks.length; i++) {
    this._onNewSessionStartCallbacks[i](this);
  }
};

AcaiClient.prototype.deleteLowerLevelDomainCookies = function () {
...
AcaiClient.prototype._getInitialDeviceId = function (configDeviceId, storedDeviceId) {
  if (configDeviceId) {
 ...
 * @private
 */
AcaiClient.prototype._trackParamsAndReferrer = function _trackParamsAndReferrer() {
  let utmProperties;
 ...
 * @private
 */
AcaiClient.prototype.runQueuedFunctions = function () {
  const queue = this._q;
  this._q = [];
 ...
 * @private
 */
AcaiClient.prototype._apiKeySet = function _apiKeySet(methodName) {
 ...
 * @private
 */
AcaiClient.prototype._loadSavedUnsentEvents = function _loadSavedUnsentEvents(unsentKey) {
 ...
 * @private
 */
AcaiClient.prototype._parseSavedUnsentEventsString = function _parseSavedUnsentEventsString(
 ...
 */
AcaiClient.prototype.isNewSession = function isNewSession() {
 ...
 * @public
 */
AcaiClient.prototype.onInit = function onInit(callback) {
 ...
 * @public
 */
AcaiClient.prototype.onNewSessionStart = function onNewSessionStart(callback) {
 ...
 */
AcaiClient.prototype.getSessionId = function getSessionId() {
 ...
 * @private
 */
AcaiClient.prototype.nextEventId = function nextEventId() {
  this._eventId++;
 ...
 * @private
 */
AcaiClient.prototype.nextIdentifyId = function nextIdentifyId() {
  this._identifyId++;
 ...
 * @private
 */
AcaiClient.prototype.nextSequenceNumber = function nextSequenceNumber() {
 ...
 * @private
 */
AcaiClient.prototype._unsentCount = function _unsentCount() {
 ...
 * @private
 */
AcaiClient.prototype._sendEventsIfReady = function _sendEventsIfReady() {
 ...
 */
AcaiClient.prototype.clearStorage = function clearStorage() {
 ...
 * @private
 */
AcaiClient.prototype._getFromStorage = function _getFromStorage(storage, key) {
 ...
 * @private
 */
AcaiClient.prototype._setInStorage = function _setInStorage(storage, key, value) {
 ...
 * @private
 */
AcaiClient.prototype._initUtmData = function _initUtmData(queryParams, cookieParams) {
 ...
 * @private
 */
AcaiClient.prototype._unsetUTMParams = function _unsetUTMParams() {
 ...
 * @private
 */
AcaiClient.prototype._getReferrer = function _getReferrer() {
 ...
 * @private
 */
AcaiClient.prototype._getUrlParams = function _getUrlParams() {
 ...
 * @private
 */
AcaiClient.prototype._saveGclid = function _saveGclid(urlParams) {
 ...
 * @private
 */
AcaiClient.prototype._saveFbclid = function _saveFbclid(urlParams) {
 ...
 * @private
 */
AcaiClient.prototype._getDeviceIdFromUrlParam = function _getDeviceIdFromUrlParam(urlParams) {
 ...
 * @private
 */
AcaiClient.prototype._getReferrerFromUrlParam = function _getReferrerFromUrlParam(urlParams) {
 ...
 * @private
 */
AcaiClient.prototype._getReferringDomain = function _getReferringDomain(referrer) {
 ...
 * @private
 */
AcaiClient.prototype._saveReferrer = function _saveReferrer(referrer) {
  if (utils.isEmptyString(referrer)) {
    return;
  }
  var referrerInfo = {
 ...
 * @private
 */
AcaiClient.prototype.saveEvents = function saveEvents() {
  try {
 ...
 */
AcaiClient.prototype.setDomain = function setDomain(domain) {
 ...
 */
AcaiClient.prototype.setUserId = function setUserId(userId, startNewSession = false) {
 ...
 */
AcaiClient.prototype.setGroup = function (groupType, groupName) {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.setOptOut = function setOptOut(enable) {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.setSessionId = function setSessionId(sessionId) {
 ...
 */
AcaiClient.prototype.resetSessionId = function resetSessionId() {
 ...
 * @public
 */
AcaiClient.prototype.regenerateDeviceId = function regenerateDeviceId() {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.setDeviceId = function setDeviceId(deviceId) {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.setTransport = function setTransport(transport) {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.setUserProperties = function setUserProperties(userProperties) {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.clearUserProperties = function clearUserProperties() {
  if (this._shouldDeferCall()) {
 ...
 */
AcaiClient.prototype.identify = function (identify_obj, opt_callback, opt_error_callback, outOfSession) {
  if (this._shouldDeferCall()) {
...
AcaiClient.prototype.groupIdentify = function (
  group_type,
  group_name,
  identify_obj,
  opt_callback,
 ...
 */
AcaiClient.prototype.setVersionName = function setVersionName(versionName) {
  if (this._shouldDeferCall()) {
 ...
 * @private
 */
AcaiClient.prototype._logEvent = function _logEvent(
  eventType,
  eventProperties,
  apiProperties,
  userProperties,
 ...
 * @private
 */
AcaiClient.prototype._limitEventsQueued = function _limitEventsQueued(queue) {
 ...
 */
AcaiClient.prototype.logEvent = function logEvent(
  eventType,
  eventProperties,
  opt_callback,
  opt_error_callback,
 ...
 */
AcaiClient.prototype.logEventWithTimestamp = function logEvent(
  eventType,
  eventProperties,
  timestamp,
  opt_callback,
 ...
 */
AcaiClient.prototype.logEventWithGroups = function (
  eventType,
  eventProperties,
  groups,
  opt_callback,
 ...
 */
AcaiClient.prototype.logRevenueV2 = function logRevenueV2(revenue_obj) {
  if (this._shouldDeferCall()) {
...
if (BUILD_COMPAT_2_0) {
   ...
   */
  AcaiClient.prototype.logRevenue = function logRevenue(price, quantity, product) {
    if (this._shouldDeferCall()) {
 ...
 * @private
 */
AcaiClient.prototype._logErrorsOnEvents = function _logErrorsOnEvents(
  maxEventId,
  maxIdentifyId,
  status,
  response,
 ...
 * @private
 */
AcaiClient.prototype.removeEvents = function removeEvents(maxEventId, maxIdentifyId, status, response) {
 ...
 * @private
 */
AcaiClient.prototype.sendEvents = function sendEvents() {
 ...
 * @private
 */
AcaiClient.prototype._mergeEventsAndIdentifys = function _mergeEventsAndIdentifys(numEvents) {
...
if (BUILD_COMPAT_2_0) {
   ...
   * @deprecated
   */
  AcaiClient.prototype.setGlobalUserProperties = function setGlobalUserProperties(userProperties) {
 ...
 */
AcaiClient.prototype.__VERSION__ = function getVersion() {
  return this.options.library.version;
};

/**
 * Sets the library name and version. Default is `acai-js` and the version defined in package.json. Used if you're building another library on top of acai-js and want a custom data source value
 * @public
 * @param {string} name - Custom library name
 * @param {string} version - Custom library version
 */
AcaiClient.prototype.setLibrary = function setLibrary(name, version) {
 ...
 * @private
 */
AcaiClient.prototype._shouldDeferCall = function _shouldDeferCall() {
 ...
 * @private
 */
AcaiClient.prototype._deferInitialization = function _deferInitialization() {
 ...
 * @public
 */
AcaiClient.prototype.enableTracking = function enableTracking() {
 ...
 */
AcaiClient.prototype._refreshDynamicConfig = function _refreshDynamicConfig() {
 ...
 */
AcaiClient.prototype.getDeviceId = function getDeviceId() {
  return this.options.deviceId;
};
 ...
 */
AcaiClient.prototype.getUserId = function getUserId() {
 ...
 */
AcaiClient.prototype.setMinTimeBetweenSessionsMillis = function setMinTimeBetweenSessionsMillis(timeInMillis) {
 ...
 */
AcaiClient.prototype.setEventUploadThreshold = function setEventUploadThreshold(eventUploadThreshold) {
 ...
 */
AcaiClient.prototype.setUseDynamicConfig = function setUseDynamicConfig(useDynamicConfig) {
 ...
 * @public
 * @param {string} serverZone - the server zone value. AcaiServerZone.US or AcaiServerZone.EU.
 ...
 * @example amplitudeClient.setServerZone(AcaiServerZone.EU, true);
 */
AcaiClient.prototype.setServerZone = function setServerZone(serverZone, serverZoneBasedApi = true) {
  if (
    (serverZone !== AcaiServerZone.EU && serverZone !== AcaiServerZone.US) ||
 ...
 * @example amplitudeClient.setServerUrl('api.acai.yourdomain.com');
 */
AcaiClient.prototype.setServerUrl = function setServerUrl(serverUrl) {
