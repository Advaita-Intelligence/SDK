import AcaiClient from './amplitude-client';
 ...
 *
 * Wraps around the current [AcaiClient](https://amplitude.github.io/Amplitude-JavaScript/) which provides more features
...
Amplitude.prototype.getInstance = function getInstance(instance) {
  ...
  if (client === undefined) {
    client = new AcaiClient(instance);
