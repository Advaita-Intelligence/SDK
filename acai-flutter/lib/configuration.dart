...
class Configuration {
  ...
  /// https://acai.io/docs/sdks/analytics/android/android-kotlin-sdk#location-tracking
  bool locationListening;

  /// Android specific
  ///
  /// Whether to use advertising id as device id.
  /// See https://acai.io/docs/sdks/analytics/android/android-kotlin-sdk#advertiser-id for more information.
  bool useAdvertisingIdForDeviceId;

  /// Android specific
  ///
  /// Whether to use app set id as device id.
  /// See https://acai.io/docs/sdks/analytics/android/android-kotlin-sdk#app-set-id for more information.
  ...
  /// Web specific
  ///
  /// Sets cookie options. See https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#configure-the-sdk
  ...
  /// See https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#remote-configuration for more information.
  ...
  /// for more granular control. See [docs](https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#autocapture) for more information.
  ...
  ///
  /// See platform-specific documentation for more information.
  /// Android: https://acai.io/docs/sdks/analytics/android/android-kotlin-sdk#configure-the-sdk
  /// iOS: https://acai.io/docs/sdks/analytics/ios/ios-swift-sdk#configure-the-sdk
  /// Web: https://acai.io/docs/sdks/analytics/browser/browser-sdk-2#configure-the-sdk
  Configuration({
