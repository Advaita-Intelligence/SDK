...
## 3.10.0
* Fix the Acai Flutter Web throw exception on setting userId to null
...
## 3.8.0
*  Support Flutter Web. Please check the example app or go to developer center to see the usage(https://docs.acai.io/docs/flutter-setup#flutter-web-support).

## 3.7.0
* Downgrade the kotlin gradle plugin to '1.3.40' to fix acai_flutter incompatible to project with kotlin gradle plugin version < 1.4.0.
