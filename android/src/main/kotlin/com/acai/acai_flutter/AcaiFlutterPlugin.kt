...
import com.acai.android.Amplitude
import com.acai.android.Configuration
import com.acai.android.DefaultTrackingOptions
import com.acai.android.TrackingOptions
import com.acai.android.events.IngestionMetadata
import com.acai.android.events.Plan
import com.acai.common.Logger
...
import com.acai.android.utilities.DefaultEventUtils
import io.flutter.embedding.engine.plugins.activity.ActivityAware
import io.flutter.embedding.engine.plugins.activity.ActivityPluginBinding
import java.lang.ref.WeakReference

class AcaiFlutterPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    companion object {
        private const val methodChannelName = "acai_flutter"
    }
        ...
        if (call.method == "init") {
            ...
            amplitude.add(
                FlutterLibraryPlugin(
                    call.argument<String>("library") ?: "acai-flutter/unknown"
                )
            )
    ...
    private fun getConfiguration(call: MethodCall): Configuration {
        ...
        call.argument<String>("serverZone")
            ?.let { configuration.serverZone = com.acai.core.ServerZone.valueOf(it.uppercase()) }
