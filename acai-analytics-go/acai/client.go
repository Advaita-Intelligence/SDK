...
import (
	"github.com/acai/analytics-go/acai/constants"
	"github.com/acai/analytics-go/acai/internal"
	...
	"github.com/acai/analytics-go/acai/storages"
)
...
func NewClient(config Config) Client {
	...
	client.Add(destination.NewAcaiPlugin())
