...
import (
	...
	"github.com/acai/analytics-go/acai/loggers"
...
func TestAcaiResponseProcessor(t *testing.T) {
	suite.Run(t, new(AcaiResponseProcessorSuite))
}

type AcaiResponseProcessorSuite struct {
	suite.Suite
}

func (t *AcaiResponseProcessorSuite) TestSuccess() {
	p := internal.NewAcaiResponseProcessor(internal.AcaiResponseProcessorOptions{
		Logger: loggers.NewDefaultLogger(),
	})
	events := t.cloneOriginalEvents()

	result := p.Process(events, internal.AcaiResponse{
...
func (t *AcaiResponseProcessorSuite) TestTimeout() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestTooLargeRequest_OneEvent() {
	events := t.cloneOriginalEvents()
	events = events[:1]
...
func (t *AcaiResponseProcessorSuite) TestTooLargeRequest() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestBadRequest_InvalidAPIKey() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestBadRequest_MissingField() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestBadRequest_InvalidEvents() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestTooManyRequests() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestProcessUnknownError_Err() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) TestProcessUnknownError_ResponseError() {
	events := t.cloneOriginalEvents()
...
func (t *AcaiResponseProcessorSuite) cloneOriginalEvents() []*types.StorageEvent {
