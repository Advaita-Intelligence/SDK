...
func (r AcaiResponse) normalizedStatus() int {
	switch {
...
func (r AcaiResponse) invalidOrSilencedEventIndexes() map[int]struct{} {
...
func (r AcaiResponse) hasThrottledEventAtIndex(eventIndex int) bool {
...
func (r AcaiResponse) hasExceededDailyQuota(event *types.Event) bool {
